...
public class ChronicleMapMarshallerAdapterTest {
    ...
    public void shouldDeserializeToTheSameObject() {
        ...
        ChronicleMapMarshallerAdapter<ObjectId> marshaller = new ChronicleMapMarshallerAdapter<>(ObjectIdCacheSerializer.INSTANCE);
        ObjectId out = marshaller.read(Bytes.allocateDirect(serialized), null);
