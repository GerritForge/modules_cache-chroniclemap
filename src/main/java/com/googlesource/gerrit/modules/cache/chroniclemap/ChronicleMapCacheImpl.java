...
public class ChronicleMapCacheImpl<K, V> extends AbstractLoadingCache<K, V>
  ...
  ChronicleMapCacheImpl(
    ...
    // XXX: Chronicle-map does not allow to custom serialize boxed primitives
  ...
  public V getIfPresent(Object objKey) {
    printMapStats(store, config.getName());
  ...
  // TODO: Remove this
  public static <K, V> void printMapStats(ChronicleMap<K, V> map, String name) {
    System.out.printf("\n******* CACHE %s *********\n", name);
