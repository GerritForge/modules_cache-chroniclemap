...
public class ChronicleMapCacheConfig {
  ...
  private static final long DEFAULT_MAX_ENTRIES = 1000;
  private static final long DEFAULT_AVG_KEY_SIZE = 1;
  private static final long DEFAULT_AVG_VALUE_SIZE = 1;
  ...
  ChronicleMapCacheConfig(
      ...
      @Assisted("DiskLimit") long diskLimit) {
    this.persistedFile =
        getCacheDir(site, cfg.getString("cache", null, "directory")).resolve(name).toFile();
    this.limit = cfg.getLong("cache", configKey, "diskLimit", diskLimit);
